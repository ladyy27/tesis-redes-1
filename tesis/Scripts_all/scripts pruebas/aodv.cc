...
int main (int argc, char **argv)
{
  ...
  std::cout <<"\tMenú\n";
  std::cout <<"Select the chart\n";
  std::cout <<"Press to 1. IPv4\n";
  std::cout <<"Press to 2. IPv6\n";
  ...
  switch (loop){
	case 1:
	  std::cout <<"Select the chart\n";
	  std::cout <<"Press to 1. UDP\n";
	  std::cout <<"Press to 2. TCP\n";
          std::cin>>loop2;
...
bool
AodvExample1::Configure (int argc, char **argv)
{
  // Enable AODV logs by default. Comment this if too noisy
  // LogComponentEnable("AodvRoutingProtocol", LOG_LEVEL_ALL);
...
void
AodvExample1::Report (std::ostream &)
{
}

void
AodvExample1::CreateNodes ()
{
  std::cout << "Creating " << (unsigned)size << " nodes " << step << " m apart.\n";
...
void
AodvExample1::InstallInternetStack ()
{
  AodvHelper aodv;
  // you can configure AODV attributes here using aodv.Set(name, value)
  InternetStackHelper stack;
...
void
AodvExample1::InstallApplications ()
{
